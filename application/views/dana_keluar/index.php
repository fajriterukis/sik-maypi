<div class="card shadow mb-4">
  ...
  <div class="card-body">
    <a href="<?= base_url('dana_keluar/tambah'); ?>" class="btn btn-primary btn-sm float-right ml-2 mb-2">Tambah</a>
    <a href="<?= base_url('dana_keluar/cetak') ?>" class="btn btn-success btn-sm float-right mb-2">
      <i class="fa fa-print"></i>
      Cetak Laporan
    </a>
    <div class="table-responsive">
      <table class="table table-bordered nowrap" id="dana_keluar" width="100%" cellspacing="0">
        <thead>
          <tr>
            <th>Menu</th>
            <th>No</th>
