<div class="container-fluid">
    ...
    <h3 class="text-center mb-4 mt-3">Rekapitulasi Dana Keseluruhan <br> Tahun Ajaran
        <?=$tahun_ajaran['tahun_ajaran'];?></h3>
    ...
    <div class="row">
        <div class="col-sm-6">
            <table border="0">
                ...
                <tr>
                    <td colspan="3">
                        <hr style="margin: 0; padding: 0; border-color: black;">
                    </td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                    <td><?="Rp." . number_format($total_dana_masuk['nominal'] + $sisa_dana['denda_infaq'], 0, ',', '.');?>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td></td>
                    <th><?="Rp." . number_format($total_dana_masuk['nominal'] + $sisa_dana['denda_infaq'] - $total_dana_keluar['uang_keluar'] - total_hutang('Infaq_Denda'), 0, ',', '.');?>
                    </th>
                </tr>
            </table>
        </div>
        ...
        <div class="col-sm-6 d-flex justify-content-end">
            <table border="0">
                ...
                <tr>
                    <td></td>
                    <td></td>
                    <td><?="Rp." . number_format($total_pembayaran_uas['nominal'] + $sisa_dana['uas'], 0, ',', '.');?>
                    </td>
                </tr>
                ...
                <tr>
                    <th>Sisa Dana UAS</th>
                    <td></td>
                    <th><?="Rp." . number_format($total_pembayaran_uas['nominal'] + $sisa_dana['uas'] - $total_dana_keluar_uas['uang_keluar'] - total_hutang('UAS'), 0, ',', '.');?>
                    </th>
                </tr>
            </table>
        </div>
        ...
        <div class="col-sm-6">
            <table border="0">
                ...
                <tr>
                    <th>Sisa Dana UN</th>
                    <td></td>
                    <th><?="Rp." . number_format($total_pelunasan_un['nominal'] + $sisa_dana['un'] - $total_dana_keluar_un['uang_keluar'] - total_hutang('UN'), 0, ',', '.');?>
                    </th>
                </tr>
            </table>
        </div>
    ...
    <div class="row" style="margin-top: 50px;">
        ...
        <div class="col-sm-4 text-center">
            <h6 class="mb-5 pb-3 font-weight-bold"><?=$data_sekolah['alamat_sekolah'];?>,
                <?=date('d') . ' ' . bulan() . ' ' . date('Y');?> <br> Kepala Madrasah</h6>
            <h6 class="font-weight-bold"><?=$data_sekolah['nama_kepsek'];?></h6>
            <h6 class="font-weight-bold">NIP. <?=$data_sekolah['nip_kepsek'];?></h6>
        </div>
    </div>
</div>